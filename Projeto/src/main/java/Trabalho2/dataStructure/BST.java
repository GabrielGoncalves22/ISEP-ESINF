...
public class BST<E extends Comparable<E>> implements BSTInterface<E> {
    ...
    protected E smallestElement(Node<E> node) {
        ...
        return smallestElement(leftNode);
    }
    ...
    /*
     * Returns a list of elements of the tree, reported in in-order.
     * @return list of the tree's elements reported in in-order
     */
    ...
    private void processBstByLevel(Node<E> node, Map<Integer, List<E>> result, int level) {
        ...
        if (result.get(level) == null) {
            List<E> nodesElementsList = new ArrayList<>();
            nodesElementsList.add(node.getElement());
            result.put(level, nodesElementsList);
        } else {
            List<E> nodesElementsList = result.get(level);
            nodesElementsList.add(node.getElement());
        }
